...
Original file is located at
    https://colab.research.google.com/drive/13AXxlI2MLMt2GvKRBpaKrNAHleIRGDth
"""
...
import pandas as pd
data = pd.read_csv('/content/gdrive/MyDrive/autism_screening.csv')
...
plt.plot([0, 0.5], [0.5, 1], linestyle='--', color='gray', label='Random Guess')
